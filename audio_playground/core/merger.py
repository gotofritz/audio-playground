...
class Merger:
    """Handle audio segment merging with lazy imports."""
    ...
    def merge_and_save(
        ...
        prompts = Merger.find_prompts_from_files(tmp_dir)
        ...
        for prompt in sorted(prompts.keys()):
            ...
            concatenated_target = Merger.concatenate_segments(target_files)
        ...
        if chain_residuals:
            ...
            if cumulative_files:
                ...
                concatenated_cumulative = Merger.concatenate_segments(cumulative_files)
